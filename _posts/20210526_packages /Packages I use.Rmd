...
- datapasta
- rio (to import multiple excel files) <https://johnmackintosh.net/tag-rio/>
- pdftools (to scrape tabular data)
...
- GGally::ggpairs() or ggstatsplot::ggcorrmat - to view correlations of variables
- DataExplorer - to automate EDA <https://boxuancui.github.io/DataExplorer/>
...
- gvlma (to check whether assumptions for normality are met)
...
## rOpenSci
  ...
  - webchem: to retrieve information from open-source databases (eg Pubchem)
...
- Big Book of R <https://www.bigbookofr.com/>404040
## Data Visualization
